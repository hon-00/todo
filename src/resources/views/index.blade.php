...
<div class="todo__content">
    <form class="create-form" action="/todo/create" method="post">
        @csrf
        ...
        <table class="todo-table__inner">
            ...
            <tr class="todo-table__row">
                <td class="todo-table__item">
                    <form class="update-form" action="/todo/update" method="get">
                ...
                <td class="todo-table__item">
                    <form class="delete-form" action="/todo/delete" method="post">
                        @csrf
